...
public class DungeonConverter {
  ...
  /**
   * Transforms the given rooms with der given local coordinates into the global coordinates of the
   * dungeon
   *
  ...
  private void drawTiles(
      Coordinate from, Coordinate to, Coordinate offset, DungeonWorld dungeon, Tile.Type tile) {
    // increasing Y same X
