package de.pmdungeon.dungeonCreator.dungeonconverter;
...
/**
 * Houses the converter, to convert a json formatted dungeon to a {@link
 * DungeonWorld.fhbielefeld.pmdungeon.game.dungeon.Dungeon} data structure
 */
public class DungeonConverter {
     ...
     */
    public DungeonWorld dungeonFromJson(String filename) {
    ...
    /**
     * Transforms the given rooms with der given local coordinates into the global coordinates of
     * the dungeon
     *
     * @param rooms Rooms the dungeon consists of
     * @return Generated dungeon
     */
    private DungeonWorld convertToDungeon(Room[] rooms) {
        Coordinate globalOffset = getOffset(rooms);
        Coordinate dungeonSize = getDungeonDimensions(globalOffset, rooms);
        DungeonWorld dungeon = new DungeonWorld(dungeonSize.getX() + 1, dungeonSize.getY() + 1);
     ...
     */
    private void drawRoomEdges(Room room, DungeonWorld dungeon) {
     ...
     */
    private void drawDoors(Room room, DungeonWorld dungeon) {
     ...
     */
    private void fillRoom(Room room, DungeonWorld dungeon) {
    ...
    /**
     * Get the position-offset of the generated dungeon to move it into the positive area of the
     * grid.
     *
