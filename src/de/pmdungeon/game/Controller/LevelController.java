...
public class LevelController {
  ...
  private void nextStage() throws InvocationTargetException, IllegalAccessException {
    switch (nextStage) {
      ...
      case B:
        loadDungeon(
            dungeonConverter.dungeonFromJson(Constants.PATHTOLEVEL + "simple_dungeon_2.json"));
        nextStage = Stage.C;
        break;
      case C:
        loadDungeon(
            dungeonConverter.dungeonFromJson(Constants.PATHTOLEVEL + "simple_dungeon.json"));
        nextStage = Stage.D;
        break;
      case D:
