...
public class MainController extends ScreenAdapter {
	...
	private void firstFrame() {
		if (!finishedSetup) {
			...
			hud = new HUD();
			textHUD = new TextStage(hud.getHudBatch());
			setupCamera();
	...
	private void setupWorldController() {
		try {
			...
			levelController = new LevelController(functionToPass, this, arguments);
	...
	private void setupCamera() {
		camera = new DungeonCamera(null, Constants.VIRTUALHEIGHT * Constants.WIDTH / Constants.HEIGHT,
