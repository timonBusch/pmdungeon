...
/**
 * Houses the converter, to convert a json formatted dungeon to a {@link DungeonWorld.fhbielefeld.pmdungeon.game.dungeon.Dungeon} data structure
 */
public class DungeonConverter {
     ...
     */
    private void drawTiles(Coordinate from, Coordinate to, Coordinate offset, DungeonWorld dungeon, Tile.Type tile) {
        //increasing Y same X
